...
Telegram-бот и покдлюченные к нему чаты управляются советами домов и не имеют отношения к действующей управляющей организации дома. Бот и чаты будут работать при смене УК, вступать в новые чаты не потребуется.
